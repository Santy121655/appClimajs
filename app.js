...
temperaturaElement.textContent = `Temperatura: ${tempCelsiusRounded}°C`;
    ...
    if (tempCelsius <= 10) {
        ...
        imagenContainer.innerHTML = '<img src="./coldday.gif" alt="Hace frío">';
    } else if (tempCelsius >= 10 && tempCelsius <= 24) {
        console.log("El día está fresco");
        body.classList.add('cool');
        imagenContainer.innerHTML = '<img src="./coolday.gif" alt="Día fresco">';
    } else {
        console.log("Hace calor");
        body.classList.add('calor');
        imagenContainer.innerHTML = '<img src="./hotday.gif" alt="Hace calor">';
    }
}